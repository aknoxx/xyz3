...
public class ObjectFactory {
    ...
    private final static QName _Search_QNAME = new QName("http://wsDef.ejb.dst3/", "search");
    private final static QName _SearchResponse_QNAME = new QName("http://wsDef.ejb.dst3/", "searchResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsDef.ejb.dst3/", name = "search")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsDef.ejb.dst3/", name = "searchResponse")
